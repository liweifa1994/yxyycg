					...
					<TABLE class="toptable grid" border=1 cellSpacing=1 cellPadding=4
						...
						<TBODY>
							...
							<TR>
								...
								<div>
								<input type="text" id="sysuser_userid" name="sysuserCustom.userid" value="${sysuser.userid}"   />
								</div>
								...
								<TD class=category width="35%">
								<div>
								<input type="text" id="sysuser_username" name="sysuserCustom.username" value="${sysuser.username}"   />
								</div>
							...
							<TR>
								...
								<TD class=category width="35%">
								<div>
									<input type="password" id="sysuser_password" name="sysuserCustom.pwd" value="${sysuser.pwd}"/>
								</div>
							...
							<TR>
								...
								<TD class=category width="35%">
								<input type="text" name="sysuserCustom.sysmc" value="${sysmc}"/>
								</TD>
								<TD height=30 width="15%" align=right>用户状态：</TD>
								<TD class=category width="35%">
								<input type="radio" name="sysuserCustom.userstate" value="1" <c:if test="${sysuser.userstate==1 || sysuser.userstate==null}">checked</c:if>/>正常
								<input type="radio" name="sysuserCustom.userstate" value="0" <c:if test="${sysuser.userstate==0}">checked</c:if>/>暂停
								</TD>
