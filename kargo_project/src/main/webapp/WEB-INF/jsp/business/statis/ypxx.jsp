...
function initGrid(){
	$('#businesslist').datagrid({
		...
		striped : true,
		//collapsible : true,
		url : '${baseurl}/statis/ypxx_result.action',
		queryParams:{
			year:'${year}'
		},
		//sortName : 'code',
				...
				<TBODY>
					...
					<TR>
					 ...
					 <INPUT id="yycgdCustom.jscgdate" 
						...
						<td colspan=2><a id="btn" href="#" onclick="businesslistquery()" class="easyui-linkbutton" iconCls='icon-search'>查询</a>
							</td>
