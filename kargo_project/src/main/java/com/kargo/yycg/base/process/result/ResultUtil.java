package com.kargo.yycg.base.process.result;
...
public class ResultUtil {
	...
	public static void throwExcepion(int  errorCode) throws ExceptionResultInfo{
		throw new ExceptionResultInfo(createFail(Config.MESSAGE,errorCode,null));
	}
	 ...
	 * @return
	 */
	public static DataGridResultInfo createQueryResult(ResultInfo resultInfo){
		return  new DataGridResultInfo(resultInfo);
	}
